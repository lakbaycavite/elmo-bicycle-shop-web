...
function Login() {
  ...
  const handlePasswordReset = () => {
    ...
    if (email) setResetEmail(email); // prefill
  };
          ...
          <div className="bg-white/20 backdrop-blur-md border border-white/30 shadow-2xl rounded-2xl p-10 w-full max-w-md text-white">
            ...
            <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                />
                {errors.email && <p className="text-sm text-red-300 mt-[2px]">{errors.email}</p>}
              </div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute top-[38px] right-3 text-gray-600 hover:text-orange-500"
                  tabIndex={-1}
                >
              ...
              <div className="modal-body p-4">
                ...
                <form onSubmit={handleResetSubmit}>
                  ...
                  <p className="text-sm text-gray-500 mb-4 border-t border-gray-100 pt-2">
                    <span className="font-medium">Note:</span> Please check your spam folder if you don't see the email.
                  </p>

                  <div className="d-flex justify-content-end gap-2 mt-2">
                    <button type="button" className="btn btn-outline-secondary" onClick={closeResetModal}>Cancel</button>
                    <button type="submit" className={`btn ${resetLoading ? 'btn-secondary' : 'btn-success text-white'}`} disabled={resetLoading}>
                      {resetLoading ? (
