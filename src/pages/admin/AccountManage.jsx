...
function AccountManage() {
  ...
  return (
    <div className="flex min-h-screen bg-white flex-col items-center p-4">
      <Sidebar userType="admin" />
      {/*Header */}
      <div className="bg-orange-500 w-[80%] py-4 px-6">
        <h1 className="text-white text-3xl font-bold">Admin Profile</h1>
      </div>
      <div className="flex items-center justify-between w-4/5 mx-auto mt-8 bg-white shadow-md p-6 rounded-lg mb-10">
      ...
      <div className="bg-white shadow-md rounded-lg w-[80%] p-4">
